...
namespace CalendarApp.Tests.UnitTests
{
        public class TimeZoneTests
    {
        ...
        public void ConvertToUtcDateTime_WithNegativeTimezone_ShouldBeSuccessful()
        {
            ...
            var date = DateTimeOffset.Parse("2021-04-30T21:00:00");
            var utcDateTime = date.ConvertTimezoneToUTC("-07:00");
            Assert.AreEqual(DateTimeOffset.Parse("2021-05-01T04:00:00+00:00"), utcDateTime);
        }
        ...
        public void ConvertToUtcDateTime_WithPositiveTimezone_ShouldBeSuccessful()
        {
            ...
            var date = DateTimeOffset.Parse("2021-05-01T06:00:00");
        ...
        public void ConvertToUtcDateTime_NegativeTimezoneWithMunites_ShouldBeSuccessful()
        {
            ...
            var date = DateTimeOffset.Parse("2021-05-01T06:30:00");
            var utcDateTime = date.ConvertTimezoneToUTC("-02:30");
            Assert.AreEqual(DateTimeOffset.Parse("2021-05-01T09:00:00+00:00"), utcDateTime);
        }
        ...
        public void ConvertToUtcDateTime_PositiveTimezoneWithMunites_ShouldBeSuccessful()
        {
            ...
            var date = DateTimeOffset.Parse("2021-05-01T09:45:00");
        ...
        {
            var dateTime = DateTimeOffset.Parse("2021-05-01T10:59:00+00:00");
            var dateTimeInTimezone = dateTime.ConvertUtcToTimezoneDateTime("+02:00");
            var ex = DateTimeOffset.Parse("2021-05-01T12:59:00+02:00");
            Assert.AreEqual(ex, dateTimeInTimezone);
        }

        [Test]
        public void ConvertUtcToTimeZone_NegativeTimezone_ShouldBeSuccessful()
        {
            var dateTime = DateTimeOffset.Parse("2021-05-01T06:59:00+00:00");
            var dateTimeInTimezone = dateTime.ConvertUtcToTimezoneDateTime("-07:00");
            Assert.AreEqual(DateTimeOffset.Parse("2021-04-30T23:59:00-07:00"), dateTimeInTimezone);
        }

        [Test]
        public void ConvertUtcToTimeZone_PositiveTimezoneWithMunites_ShouldBeSuccessful()
        {
            var dateTime = DateTimeOffset.Parse("2021-05-01T06:00:00+00:00");
            var dateTimeInTimezone = dateTime.ConvertUtcToTimezoneDateTime("+05:45");
            Assert.AreEqual(DateTimeOffset.Parse("2021-05-01T11:45:00+05:45"), dateTimeInTimezone);
        }
        [Test]
        public void sample()
        {
            // Warsaw timezone = GMT+02:00
            var date = DateTimeOffset.Parse("2021-05-01T18:53:00");
            var utcDateTime = date.ConvertTimezoneToUTC("+02:00");
